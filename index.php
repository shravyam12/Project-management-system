    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
             <form class="form-signin" method="post" action="log_val.php">
              <div class="form-label-group">
                <br>
                <input type="text" id="inputName" class="form-control" name="usn" placeholder="USN" required autofocus>
                <br>
             </div>
              <div class="form-label-group">
...
<!-- Footer -->
    <footer>
      <div class="container text-center">
        <p>Copyright &copy; Project Database System 2023</p>
      </div>
    </footer>
